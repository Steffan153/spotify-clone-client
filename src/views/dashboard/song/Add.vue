  ...
  <div class="mainInner">
    ...
    <form @submit.prevent="sumbit">
      ...
      <div class="group">
        ...
        <input type="text" id="artist" v-model="artist" placeholder="(optional)" />
      </div>
      <div class="group">
...
export default {
  ...
  methods: {
    ...
    async sumbit() {
      if (!this.name || !this.playlistId || !this.song) return;
      this.loading = true;
      this.$Progress.start();
      try {
        ...
        await axios.post("/api/songs", sendData, {
          headers: {
